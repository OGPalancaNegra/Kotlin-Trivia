 ...
 */
interface GeneralKnowledgeAPIService {
 ...
 */
object GeneralKnowledgeQAPI {
    val RETROFIT_SERVICE : GeneralKnowledgeAPIService by lazy  { retrofit.create(GeneralKnowledgeAPIService::class.java) }
}
